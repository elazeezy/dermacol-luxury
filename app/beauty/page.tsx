...
import { ShoppingBag, X, ZoomIn, Calendar, Search, ArrowUpDown, Loader2 } from 'lucide-react';
                ...
                >
                  ...
                  >
                    {wig.is_video ? (
                      ...
                      <img src={wig.media_url} alt={wig.name} className="w-full h-full object-cover" />
                    )}
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <div className="flex flex-col">
                      {wig.old_price && wig.old_price !== "N/A" && (
                        <span className="text-[8px] text-gray-400 line-through tracking-tighter">₦{wig.old_price}</span>
                      )}
                      <span className="text-sm font-black text-[#FF85A1]">₦{wig.new_price.toLocaleString()}</span>
                    </div>
                    <button
                      onClick={() => addToCart({
                        id: `wig-${wig.id}`,
